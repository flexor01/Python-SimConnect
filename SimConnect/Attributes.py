...
class SimConnectDll(object):
    ...
    def __init__(self, library_path):
        ...
        self.RequestDataOnSimObjectType = self.SimConnect.SimConnect_RequestDataOnSimObjectType
        ...
        self.MapClientEventToSimEvent = self.SimConnect.SimConnect_MapClientEventToSimEvent
        ...
        self.AddClientEventToNotificationGroup = self.SimConnect.SimConnect_AddClientEventToNotificationGroup
        ...
        #   SIMCONNECT_NOTIFICATION_GROUP_ID GroupID
        #   DWORD uPriority);
        self.SetNotificationGroupPriority = self.SimConnect.SimConnect_SetNotificationGroupPriority
        ...
        #   DWORD dwReserved = 0
        #   DWORD Flags = 0);
        self.RequestNotificationGroup = self.SimConnect.SimConnect_RequestNotificationGroup
        ...
        #   DWORD UpValue = 0
        #   BOOL bMaskable = FALSE);
        self.MapInputEventToClientEvent = self.SimConnect.SimConnect_MapInputEventToClientEvent
        ...
        #   HANDLE hSimConnect,
        #   SIMCONNECT_CLIENT_EVENT_ID EventID);
        self.UnsubscribeFromSystemEvent = self.SimConnect.SimConnect_UnsubscribeFromSystemEvent
        ...
        #   float lon
        #   float alt);
        self.WeatherRequestInterpolatedObservation = self.SimConnect.SimConnect_WeatherRequestInterpolatedObservation
        ...
        #   SIMCONNECT_DATA_REQUEST_ID RequestID
        #   const char * szICAO);
        self.WeatherRequestObservationAtStation = self.SimConnect.SimConnect_WeatherRequestObservationAtStation
        ...
        #   float lat
        #   float lon);
        self.WeatherRequestObservationAtNearestStation = self.SimConnect.SimConnect_WeatherRequestObservationAtNearestStation
        ...
        #   HANDLE hSimConnect,
        #   DWORD dwRate);
        self.WeatherSetDynamicUpdateRate = self.SimConnect.SimConnect_WeatherSetDynamicUpdateRate
        ...
        #   float maxAlt
        #   DWORD dwFlags = 0);
        self.WeatherRequestCloudState = self.SimConnect.SimConnect_WeatherRequestCloudState
        ...
        #   SIMCONNECT_DATA_REQUEST_ID RequestID);
        self.AICreateParkedATCAircraft = self.SimConnect.SimConnect_AICreateParkedATCAircraft
        ...
        #   BOOL bTouchAndGo
        #   SIMCONNECT_DATA_REQUEST_ID RequestID);
        self.AICreateEnrouteATCAircraft = self.SimConnect.SimConnect_AICreateEnrouteATCAircraft
        ...
        #   SIMCONNECT_DATA_INITPOSITION InitPos
        #   SIMCONNECT_DATA_REQUEST_ID RequestID);
        self.AICreateSimulatedObject = self.SimConnect.SimConnect_AICreateSimulatedObject
        ...
        #   const char * szFlightPlanPath
        #   SIMCONNECT_DATA_REQUEST_ID RequestID);
        self.AISetAircraftFlightPlan = self.SimConnect.SimConnect_AISetAircraftFlightPlan
        ...
        self.CameraSetRelative6DOF.argtypes = [c_float, c_float, c_float, c_float, c_float, c_float]
        ...
        self.MenuAddSubItem.argtypes = [HANDLE, SIMCONNECT_CLIENT_EVENT_ID, c_char_p, SIMCONNECT_CLIENT_EVENT_ID, DWORD]
        ...
        self.MenuDeleteSubItem.argtypes = [HANDLE, SIMCONNECT_CLIENT_EVENT_ID, SIMCONNECT_CLIENT_EVENT_ID]
        ...
        #   HANDLE hSimConnect,
        #   SIMCONNECT_FACILITY_LIST_TYPE type);
        self.UnsubscribeToFacilities = self.SimConnect.SimConnect_UnsubscribeToFacilities
